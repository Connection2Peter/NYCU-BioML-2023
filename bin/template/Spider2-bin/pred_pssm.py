...
def load_NN(nn_filename):
	return numpy.load(nn_filename, allow_pickle=True, encoding='latin1')
...
if __name__ == "__main__":
	...
	if os.path.isfile(nndir+'/Spider2-data/pp1.npz'): nndir += '/Spider2-data/'
	elif os.path.isfile(nndir+'/../Spider2-data/pp1.npz'): nndir += '/../Spider2-data/'
